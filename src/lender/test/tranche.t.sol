...
contract TrancheTest is DSTest, Math, FixedPoint {
    ...
    function testSimpleDisburse() public {
        ...
        (payoutCurrencyAmount, payoutTokenAmount, remainingSupplyCurrency, remainingRedeemToken) = tranche.calcDisburse(self);
        ...
        // execute disburse
        (payoutCurrencyAmount, payoutTokenAmount, remainingSupplyCurrency, remainingRedeemToken) = tranche.disburse(self);
        assertEq(payoutTokenAmount, 80 ether);
        assertEq(remainingSupplyCurrency, 20 ether);
    ...
    function testRedeemDisburse() public {
        ...
        reserve.setReturn("balance", uint256(-1));
    ...
    function testDisburseEndEpochMultiple() public {
        ...
        (payoutCurrencyAmount, payoutTokenAmount, remainingSupplyCurrency, remainingRedeemToken) = tranche.disburse(self, endEpoch);

        assertEq(payoutTokenAmount, 0);

        (payoutCurrencyAmount, payoutTokenAmount, remainingSupplyCurrency, remainingRedeemToken) = tranche.disburse(self, endEpoch + 1);
        // 90 ether * 0.1
