...
interface TitleMockInterface extends ethers.utils.Interface {
  functions: {
...
export class TitleMock extends BaseContract {
  ...
  callStatic: {
    ...
    ownerOf(loan: BigNumberish, overrides?: CallOverrides): Promise<string>;
