...
interface ShelfLikeInterface extends ethers.utils.Interface {
  functions: {
...
export class ShelfLike extends BaseContract {
  ...
  estimateGas: {
    ...
    shelf(loan: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  };
