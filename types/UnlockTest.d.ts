...
interface UnlockTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "testFailUnlockCollected()": FunctionFragment;
    "testFailUnlockNotLoanOwner()": FunctionFragment;
    "testFailUnlockOpenDebt()": FunctionFragment;
    "testUnlockNFT()": FunctionFragment;
    "testUnlockNFTAfterRepay()": FunctionFragment;
    "topUp(address)": FunctionFragment;
    "transferNFT(address,address,uint256)": FunctionFragment;
    "unlockNFT(uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFailUnlockCollected",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailUnlockNotLoanOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailUnlockOpenDebt",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testUnlockNFT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testUnlockNFTAfterRepay",
    values?: undefined
  ): string;
...
export class UnlockTest extends BaseContract {
  ...
  functions: {
    ...
    testFailUnlockCollected(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testFailUnlockNotLoanOwner(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testFailUnlockOpenDebt(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    testFailUnlockCollected(overrides?: CallOverrides): Promise<void>;

    testFailUnlockNotLoanOwner(overrides?: CallOverrides): Promise<void>;

    testFailUnlockOpenDebt(overrides?: CallOverrides): Promise<void>;

    testUnlockNFT(overrides?: CallOverrides): Promise<void>;

    testUnlockNFTAfterRepay(overrides?: CallOverrides): Promise<void>;
