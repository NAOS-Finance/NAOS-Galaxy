...
interface LenderIntegrationTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "testExecuteSimpleEpoch()": FunctionFragment;
    "testSimpleSeniorOrder()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testExecuteSimpleEpoch",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSimpleSeniorOrder",
    values?: undefined
  ): string;
...
export class LenderIntegrationTest extends BaseContract {
  ...
  interface: LenderIntegrationTestInterface;
  ...
  functions: {
    ...
    testExecuteSimpleEpoch(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testSimpleSeniorOrder(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    testExecuteSimpleEpoch(overrides?: CallOverrides): Promise<void>;

    testSimpleSeniorOrder(overrides?: CallOverrides): Promise<void>;
