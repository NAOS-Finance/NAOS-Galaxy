...
interface ReserveTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "fundReserve(uint256)": FunctionFragment;
    ...
    "testDepositPayout()": FunctionFragment;
    "testFailBalanceBorrowAmountTooHigh()": FunctionFragment;
    "testFailBalancePoolInactive()": FunctionFragment;
    "testFailBalanceReserveUnderfunded()": FunctionFragment;
    "testFailBalanceShelfNotEnoughFunds()": FunctionFragment;
    "testReserveBalanceBorrowFullReserve()": FunctionFragment;
    "testReserveBalanceBorrowPartialReserve()": FunctionFragment;
    "testReserveBalanceRepay()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testDepositPayout",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailBalanceBorrowAmountTooHigh",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailBalancePoolInactive",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailBalanceReserveUnderfunded",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailBalanceShelfNotEnoughFunds",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testReserveBalanceBorrowFullReserve",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testReserveBalanceBorrowPartialReserve",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testReserveBalanceRepay",
    values?: undefined
  ): string;
...
export class ReserveTest extends BaseContract {
  ...
  functions: {
    ...
    testFailBalanceBorrowAmountTooHigh(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testFailBalancePoolInactive(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testFailBalanceReserveUnderfunded(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testFailBalanceShelfNotEnoughFunds(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testReserveBalanceBorrowFullReserve(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testReserveBalanceBorrowPartialReserve(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testReserveBalanceRepay(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  };
  ...
  callStatic: {
    ...
    fundReserve(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    testDepositPayout(overrides?: CallOverrides): Promise<void>;

    testFailBalanceBorrowAmountTooHigh(
      overrides?: CallOverrides
    ): Promise<void>;

    testFailBalancePoolInactive(overrides?: CallOverrides): Promise<void>;

    testFailBalanceReserveUnderfunded(overrides?: CallOverrides): Promise<void>;
    ...
    testReserveBalanceRepay(overrides?: CallOverrides): Promise<void>;
  };
