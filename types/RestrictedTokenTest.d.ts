...
interface RestrictedTokenTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "testFailReceiveTokensMembershipExpired()": FunctionFragment;
    "testFailReceiveTokensNotMember()": FunctionFragment;
    "testReceiveTokens()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFailReceiveTokensMembershipExpired",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailReceiveTokensNotMember",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testReceiveTokens",
    values?: undefined
  ): string;
...
export class RestrictedTokenTest extends BaseContract {
  ...
  interface: RestrictedTokenTestInterface;
  ...
  functions: {
    ...
    testFailReceiveTokensMembershipExpired(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testFailReceiveTokensNotMember(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    testFailReceiveTokensNotMember(overrides?: CallOverrides): Promise<void>;

    testReceiveTokens(overrides?: CallOverrides): Promise<void>;
  };
