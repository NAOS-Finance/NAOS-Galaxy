...
interface IssueTestInterface extends ethers.utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "addKeeperAndCollect(uint256,address,uint256)": FunctionFragment;
    "admin()": FunctionFragment;
    "assertEq(uint256,uint256,uint256)": FunctionFragment;
    "assertPostCondition(uint256,uint256,bytes32)": FunctionFragment;
    "assertPreCondition(uint256,bytes32)": FunctionFragment;
    ...
    "issueLoan(uint256,bytes32)": FunctionFragment;
    ...
    "testFailIssueLoanNotNFTOwner()": FunctionFragment;
    "testFailIssueMultipleLoansForOneNFT()": FunctionFragment;
    "testIssueLoan()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFailIssueLoanNotNFTOwner",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testFailIssueMultipleLoansForOneNFT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testIssueLoan",
    values?: undefined
  ): string;
  ...
  decodeFunctionResult(functionFragment: "issueLoan", data: BytesLike): Result;
...
export class IssueTest extends BaseContract {
  ...
  functions: {
    ...
    testFailIssueLoanNotNFTOwner(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testFailIssueMultipleLoansForOneNFT(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    testFailIssueLoanNotNFTOwner(overrides?: CallOverrides): Promise<void>;

    testFailIssueMultipleLoansForOneNFT(
      overrides?: CallOverrides
    ): Promise<void>;

    testIssueLoan(overrides?: CallOverrides): Promise<void>;
