...
interface LenderDeployerLikeInterface extends ethers.utils.Interface {
  functions: {
...
export class LenderDeployerLike extends BaseContract {
  ...
  interface: LenderDeployerLikeInterface;
